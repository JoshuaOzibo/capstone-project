          ...
          >
            <div className="bg-white transition-all px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <span className=" w-full mb-5 space-x-5 bg-gray-100  flex items-center justify-center">
                    <button onClick={() => setIsTrue(true)} className={isTrue ? "border shadow-md bg-slate-400 w-full py-2 rounded-md" : "border w-full py-2 rounded-md"}>SignUp</button>
                    <button onClick={() => setIsTrue(false)}  className={isTrue ? "border w-full py-2 rounded-md" : "border w-full py-2 bg-slate-400 shadow-md rounded-md"}>Login</button>
                </span>
              <div>
